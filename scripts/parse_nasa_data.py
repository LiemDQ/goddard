...
def parse_physical_params(params: str):
    # print(params)
    values = params.split()
    if len(values) == 2: #electron is a special case
        return False, float(values[0]), values[1]
...
if __name__ == "__main__":
    ...
    with open(filename, 'r') as f:
        ...
        while not f.readline().startswith("thermo"):
            continue
    ...
    output_file = "./nasa_reactants_h2o2.yaml"
