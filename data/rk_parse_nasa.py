...
if __name__ == "__main__":
    ...
    output_file = "./nasa_database.yaml"
    with open(filename, 'r') as f:
        textlines = createTextLines(f)

    species_list = createNasaSpeciesList(textlines)
    database = createDatabase(species_list)
    
    
    with open(output_file, 'w') as f:
        f.write("# Autogenerated by parse_nasa_data.py.\n# Do not edit manually.\n\n")
        f.write("species:\n")
        f.write(yaml.safe_dump(database, default_flow_style=False))
